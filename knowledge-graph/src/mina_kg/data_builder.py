...
def build_dataset() -> dict[str, Any]:
    ...
    skills = [
        skill("MATH.G6.FRACTION.REPRESENT", "Biểu diễn một số nguyên dưới dạng phân số", 6, "Numbers", "Fractions", "Viết số nguyên a dưới dạng a/1 và nhận biết tử số, mẫu số.", g6_l23),
        ...
        skill("MATH.G7.RATIONAL.REPRESENT", "Biểu diễn và xác định số đối của số hữu tỉ", 7, "Numbers", "RationalNumbers", "Biểu diễn số hữu tỉ, xác định số đối và vị trí tương ứng.", g7_l1),
    ...
    def edge(source: str, target: str, evidence: str, confidence: float = 0.9) -> dict[str, Any]:
        return {
    ...
    edges = [
        ...
        edge("MATH.G6.FRACTION.COMMON_DENOMINATOR", "MATH.G6.FRACTION.COMPARE", "So sánh phân số khác mẫu có thể thực hiện sau khi đưa về cùng mẫu."),
        ...
        edge("MATH.G6.FRACTION.REDUCE", "MATH.G6.FRACTION.ADD_SUBTRACT", "Kết quả phép tính phân số cần được rút gọn."),
        edge("MATH.G6.FRACTION.REDUCE", "MATH.G6.FRACTION.MULTIPLY_DIVIDE", "Rút gọn trước hoặc sau phép nhân/chia giúp đưa kết quả về dạng tối giản."),
        ...
        edge("MATH.G7.RATIONAL.RECOGNIZE", "MATH.G7.RATIONAL.REPRESENT", "Cần nhận biết số hữu tỉ trước khi biểu diễn và xác định số đối."),
    ...
    misconceptions = [
        {"id": "MIS.FRACTION.ADD_NUMERATOR_DENOMINATOR", "description": "Cộng riêng tử số và mẫu số", "error_pattern": "a/b + c/d = (a+c)/(b+d)", "severity": "fundamental", "skill_ids": ["MATH.G6.FRACTION.COMMON_DENOMINATOR", "MATH.G6.FRACTION.ADD_SUBTRACT"], "review_status": REVIEW_STATUS},
        {"id": "MIS.FRACTION.WRONG_COMMON_DENOMINATOR", "description": "Chọn mẫu số chung bằng tổng hai mẫu hoặc không biến đổi tử số tương ứng", "error_pattern": "MSC(b,d) = b+d or numerator unchanged", "severity": "fundamental", "skill_ids": ["MATH.G6.FRACTION.COMMON_DENOMINATOR"], "review_status": REVIEW_STATUS},
        ...
        {"id": "MIS.FRACTION.DIVIDE_WITHOUT_RECIPROCAL", "description": "Chia tử cho tử và mẫu cho mẫu hoặc không dùng nghịch đảo", "error_pattern": "a/b : c/d != a/b * d/c", "severity": "major", "skill_ids": ["MATH.G6.FRACTION.MULTIPLY_DIVIDE", "MATH.G7.RATIONAL.MULTIPLY_DIVIDE"], "review_status": REVIEW_STATUS},
    ]
    ...
    questions = [
        ...
        },
        {
            ...
            "options": [option("A", "12", True), option("B", "10", misconception_id="MIS.FRACTION.WRONG_COMMON_DENOMINATOR"), option("C", "24"), option("D", "2")],
        ...
        },
        {
            ...
            "options": [option("A", "5/12", True), option("B", "2/10", misconception_id="MIS.FRACTION.ADD_NUMERATOR_DENOMINATOR"), option("C", "2/12", misconception_id="MIS.FRACTION.WRONG_COMMON_DENOMINATOR"), option("D", "1/10")],
        ...
        },
        {
            ...
            "options": [option("A", "4/6", True), option("B", "2/6", misconception_id="MIS.FRACTION.WRONG_COMMON_DENOMINATOR"), option("C", "7/6"), option("D", "4/3")],
        ...
        },
        {
            ...
            "options": [option("A", "5/6", True), option("B", "3/9", misconception_id="MIS.FRACTION.ADD_NUMERATOR_DENOMINATOR"), option("C", "3/6", misconception_id="MIS.FRACTION.WRONG_COMMON_DENOMINATOR"), option("D", "1/2")],
        ...
        },
        {
            ...
            "options": [option("A", "11/10", True), option("B", "1/10", misconception_id="MIS.RATIONAL.IGNORE_NEGATIVE_SIGN"), option("C", "2/3", misconception_id="MIS.FRACTION.ADD_NUMERATOR_DENOMINATOR"), option("D", "-11/10")],
    ...
    return {
        ...
        "dataset": {"id": "MINA_KNTT_MATH_G6_G7_DEMO_V1", "series": "KNTT", "subject": "math", "grades": [6, 7], "review_status": REVIEW_STATUS},
        "skills": skills,
        "edges": edges,
