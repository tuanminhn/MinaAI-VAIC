...
- MVP chỉ xử lý dữ liệu bộ Kết nối tri thức với cuộc sống, môn Toán lớp 7 và lớp 8; không mở rộng sang bộ sách, môn hoặc khối khác.
- Diagnostic không truy ngược sang dữ liệu lớp 6 trở xuống trong MVP; trường hợp vượt phạm vi phải được báo rõ thay vì suy đoán.
