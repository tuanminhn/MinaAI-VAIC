...
Phạm vi nội dung bị khóa: **Kết nối tri thức với cuộc sống — môn Toán lớp 7 và lớp 8**.
...
→ giao diagnostic Toán 7 hoặc 8 Kết nối tri thức
...
**Mục tiêu:** Chuẩn bị toàn bộ dữ liệu giáo dục cần cho kịch bản demo, chỉ sử dụng Toán lớp 7–8 bộ Kết nối tri thức.
...
- Trình bày phạm vi MVP chính xác: Kết nối tri thức, Toán lớp 7–8.
...
1. Một dataset demo đã duyệt thuộc Toán 7–8 Kết nối tri thức.
